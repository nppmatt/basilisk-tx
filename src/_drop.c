...
}{end_tracing("init_1","drop.c",226);return 0;}end_tracing("init_1","drop.c",226);}
...
#line 236 "drop.c"
event_register((Event){0,1,properties_1,{properties_1_expr0},((int *)0),((double *)0),"drop.c",236,"properties"});
